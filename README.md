...
- **CSS3 (Grid & Flexbox)**: Construção de layouts responsivos complexos e alinhamentos de precisão.
- **JavaScript (Vanilla)**: Lógica de interação para o funcionamento de Perguntas Frequentes (FAQ Accordion).
- **Gulp**: Ferramenta de automação de tarefas configurada para compilação do SASS em CSS minificado e compressão otimizada de imagens.
...
```bash
git clone [https://github.com/VitorV9/landing-page-interestelar]